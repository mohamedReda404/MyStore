...
namespace AppStore.Migrations
{
    ...
    [Migration("20260705145316_fix-ConflectinfOREGINGKEYPRODUCT-Table-BrandId-Brand-Table")]
    partial class fixConflectinfOREGINGKEYPRODUCTTableBrandIdBrandTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppStore.Brands.Brand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AppStore.Categorys.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AppStore.Products.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AppStore.Brands.Brand", b =>
                {
                    b.HasOne("AppStore.Products.Product", "Product")
                        .WithMany("brands")
            ...
            modelBuilder.Entity("AppStore.Products.Product", b =>
                {
                    b.HasOne("AppStore.Categorys.Category", "category")
                        .WithMany("Product")
