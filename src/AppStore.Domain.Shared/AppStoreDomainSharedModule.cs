...
public class AppStoreDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        AppStoreGlobalFeatureConfigurator.Configure();
        AppStoreModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<AppStoreDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<AppStoreResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/AppStore");

            options.DefaultResourceType = typeof(AppStoreResource);
        ...
        {
            options.MapCodeNamespace("AppStore", typeof(AppStoreResource));
        });
    }
}
